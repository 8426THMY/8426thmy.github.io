...
\end{enumerate}
\noindent Note that all of these \textcolor{red}{lift uniquely from the Haagerup-Izumi subcategory (check)} except for $A_2^1$ and $A_2^2$. In particular, since $\mathbbm{1} \oplus Y$ and $\mathbbm{1} \oplus gY$ have unique algebra structures in the Haagerup-Izumi subcategory, \textcolor{red}{$A_2^5$ can't exist}, implying that either $A_2^1$ or $A_2^2$ has two algebra structures. Checking the bimodules returned by the code, only $A_2^1$ and $A_2^2$ can provide Morita equivalences to $\mathcat{C}$ (or they can be self-dual), while $A_2^4$ and $A_2^6$ have two dual candidates of rank 8, one of which being $\mathcat{D}_1$. The object $A_2^3$ must be self-dual.
%Rep 1: 980
%	Near-group
%	Self-dual
%
...
%
%Rep 4: 2277
%	Two options of rank 8, so probably D_1
%
%Rep 5: 7115
%	Self-dual
%
...
% Is this for D_1? I can't remember...
%Rep 1: 3458
%	Near-group
